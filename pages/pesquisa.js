...
const Pesquisa = () => {
  ...
  return (
    <div className='pt-6'>
      ...
      <p className='text-center mb-6' >O retaurante x sempre busca por atender melhor seus clientes.<br />
      ...
      {!sucess && <div className='w-1/5 mx-auto'>
        ...
        <button className='bg-blue-400 px-6 py-4 font-bold rounded-lg shadow-lg houver:shadow mb-6' onClick={save}>Salvar</button>
      </div>}

      {sucess && <div className='w-1/5 mx-auto'>
        <p className='mb-6 text-center pbg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3'>Obrigado por contribuir com sua crítica ou sugestão.</p>
        {
